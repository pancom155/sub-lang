...
router.post('/products/add', upload.single('productImage'), AdminController.createProduct);
router.get('/products/edit/:id', AdminController.editProductForm); 
router.post('/products/edit/:id', upload.single('productImage'), AdminController.editProduct);
